...
%
    ...
    \begin{figure}[h!]
        \begin{center}
            \input{diag/cannon}
            \caption{\label{fig:cannon} Path of cannon ball fired from atop a cliff.\protect\footnotemark}
        \end{center}
    \end{figure}
    \footnotetext{Cannon icon: https://www.onlinewebfonts.com/icon/7548}
    \answer{12}{B}
    ...
    \begin{figure}[h!]
        \begin{center}
            \input{diag/plane}
            \caption{\label{fig:plane} Path of package dropped from a flying plane.\protect\footnotemark}
        \end{center}
    \end{figure}
    \footnotetext{Airplane icon made by Freepik from www.flaticon.com}
    \answer{14}{D}
    ...
    \begin{figure}[h!]
       \begin{center}
          \input{diag/vehicles}
          \caption{\label{fig:vehicles} Truck being pushed by a small car.\protect\footnotemark}
       \end{center}
    \end{figure}
    \footnotetext{Truck icon: https://commons.wikimedia.org/wiki/File:RWBA\_LKW.svg. Car icon: https://commons.wikimedia.org/wiki/File:RWBA\_PKW.svg. Exhaust Gas by Luis Prado from the Noun Project.}

    \begin{mcq}{Q.15}{While the car is pushing the truck and their speed is increasing:}
