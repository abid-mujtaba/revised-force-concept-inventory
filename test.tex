...
%
    ...
    \footnotetext{Truck icon: https://commons.wikimedia.org/wiki/File:RWBA\_LKW.svg.\\\phantom{MM}Car icon: https://commons.wikimedia.org/wiki/File:RWBA\_PKW.svg.\\\phantom{MM}Exhaust Gas by Luis Prado from the Noun Project.}
