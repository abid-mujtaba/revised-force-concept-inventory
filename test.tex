...
\begin{document}
    ...
    \eline[2]
    The next two question (5 and 6) are based on Fig.~\ref{circular-channel} which shows a horizontal frictionless channel in the shape of a segment (part) of a circle with center at \textbf{O}.
    The channel is placed on top of a horizontal frictionless table and a ball is shot at high speed in to it at end \textbf{P} and leaves at end \textbf{R}.
    Air resistance is negligible.

    \begin{figure}[h!]\label{circular-channel}
        \begin{center}
            \eline[]
            \input{diag/circular_channel}
            \caption{Ball travelling in an horizontal frictionless channel.}
        \end{center}
    \end{figure}
