...
% \tikzset{external/system call={pdflatex -fmt=preamble.fmt \tikzexternalcheckshellescape -shell-escape -halt-on-error -interaction=nonstopmode -jobname "\image" "\texsource"}}
